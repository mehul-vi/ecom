  ...
  return (
    <div className='w-full min-h-[50vh] flex flex-col items-center justify-center gap-12 bg-white py-16 px-4'>
      <div className='text-center w-full max-w-4xl'>
        ...
        <p className='text-secondary text-lg font-medium max-w-xl mx-auto'>Customer-Friendly Policies – Committed to Your Satisfaction and Safety.</p>
      </div>
      <div className='flex flex-wrap justify-center gap-16'>
        <div className='w-[300px] flex flex-col items-center gap-4 text-center'>
          ...
          <p className='text-sm text-secondary font-medium'>Exchange Made Easy – Quick, Simple, and Customer-Friendly Process.</p>
        </div>
        <div className='w-[300px] flex flex-col items-center gap-4 text-center'>
          ...
          <p className='text-sm text-secondary font-medium'>Shop with Confidence – 7 Days Easy Return Guarantee.</p>
        </div>
        <div className='w-[300px] flex flex-col items-center gap-4 text-center'>
          ...
          <p className='text-sm text-secondary font-medium'>Trusted Customer Support – Your Satisfaction Is Our Priority.</p>
        </div>
      </div>
    </div>
  )
